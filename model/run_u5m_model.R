## #######################################################################################
##
## RUN U5M GEOSTATISTICAL MODEL
##
## NOTES: Set lines 15-41; all variables below line 41 are either fixed file paths or
##  based on arguments in `config.csv`
##
## #######################################################################################
